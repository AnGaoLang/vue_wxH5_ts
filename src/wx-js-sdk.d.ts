...
declare namespace jWeixin {
	 ...
	 */
	function onMenuShareTimeline(params: Partial<IOnMenuShareTimeline>): void;
	function updateTimelineShareData(params: Partial<IOnMenuShareTimeline>): void;
	 ...
	 */
	function onMenuShareAppMessage(params: Partial<IOnMenuShareAppMessage>): void;
	 ...
	 */
	function onMenuShareQQ(params: Partial<IOnMenuShareQQ>): void;
	 ...
	 */
	function onMenuShareWeibo(params: Partial<IOnMenuShareWeibo>): void;
...
declare namespace jWeixin {
	 ...
	 * 监听录音自动停止接口
	 */
	function onVoiceRecordEnd(params: Partial<IOnVoiceRecordEnd>): void;

	/**
	 * 播放语音接口
	 */
	function playVoice(params: CacheQueryOptions): void;

	/**
	 * 暂停播放接口
	 */
	function pauseVoice(params: Resouce): void;
	/**
	 * 停止播放接口
	 */
	function stopVoice(params: Resouce): void;
	 ...
	 */
	function uploadVoice(params: Partial<IUpdownloadVoice>): void;

	/**
	 * 下载语音接口
	 */
	function downloadVoice(params: Partial<IUpdownloadVoice>): void;
}
...
declare namespace jWeixin {
	 ...
	 * 批量隐藏功能按钮接口
	 */
	function hideMenuItems(options: IHideMenuItems): void;
...
declare namespace jWeixin {
	 ...
	 * 批量添加卡券接口
	 */
	function addCard(options: IAddCard): void;
...
declare namespace jWeixin {
	...
	interface IOpenAddress extends BaseParams {
		success(ret: IAddress): void;
	}

	function openAddress(options: IOpenAddress): void;
}
